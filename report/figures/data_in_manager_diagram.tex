...
\draw[data] ([xshift=-21mm,yshift=18mm]compact.north) -- ([xshift=-21mm]compact.north)
  node[pos=0.62,left,sig] {\texttt{data\_in\_valid}};

\draw[bus] ([yshift=18mm]compact.north) -- (compact.north)
  node[pos=0.62,right,sig,xshift=2pt] {\texttt{data\_in\_data}};

\draw[bus] ([xshift=21mm,yshift=18mm]compact.north) -- ([xshift=21mm]compact.north)
  node[pos=0.62,right,sig] {\texttt{data\_in\_keep}};
...
\draw[data] ([xshift=-38mm,yshift=7mm]ctrlblk.west) -- ([yshift=7mm]ctrlblk.west)
  node[pos=0.48,above,sig] {\texttt{config\_ready}};

\draw[data] ([xshift=-38mm]ctrlblk.west) -- (ctrlblk.west)
  node[pos=0.48,above,sig] {\texttt{config\_last}};

\draw[data] ([xshift=-38mm,yshift=-7mm]ctrlblk.west) -- ([yshift=-7mm]ctrlblk.west)
  node[pos=0.48,below,sig] {\texttt{data\_in\_last}};
...
\draw[data] (dinreadyA) -- (dinreadyTop)
  node[midway,right,sig] {\texttt{data\_in\_ready}};
...
\draw[data] ([xshift=38mm,yshift=6mm]binfifo.east) -- ([yshift=6mm]binfifo.east)
  node[pos=0.48,above,sig] {\texttt{bnn\_ready}};

\draw[data] ([xshift=38mm,yshift=-6mm]binfifo.east) -- ([yshift=-6mm]binfifo.east)
  node[pos=0.48,below,sig] {\texttt{bnn\_en}};

% Outputs to BNN
\draw[bus] ([xshift=-17mm]binfifo.south) -- ++(0,-2.6)
  node[below,sig] {\texttt{bnn\_data\_in}};

\draw[data] ([xshift=17mm]binfifo.south) -- ++(0,-2.6)
  node[below,sig] {\texttt{bnn\_data\_in\_valid}};
