...
class bnn_fcc_tkeep_packet_test extends bnn_fcc_base_test;
    `uvm_component_utils(bnn_fcc_tkeep_packet_test)

    function new(string name = "bnn_fcc_tkeep_packet_test", uvm_component parent = null);
        super.new(name, parent);
    endfunction

    task run_phase(uvm_phase phase);
        bnn_fcc_config_tkeep_packet_sequence cfg_seq;
