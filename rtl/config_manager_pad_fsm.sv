    ...
    case (state_r)
      IDLE: begin
        if (payload_start) begin
          ...
          next_bytes_per_neuron    = decode_weight_bytes_per_neuron(layer_id);
          next_bytes_per_word      = decode_weight_bytes_per_word(layer_id);
          next_byte_idx            = '0;
        ...
        if (last_rd_r) begin
          ...
          if (!msg_type_r) begin
            ...
            if (byte_idx_r == (bytes_per_neuron_r - 1'b1)) begin
              ...
              if ((bytes_per_neuron_r[7:0] & (bytes_per_word_r - 1'b1)) != '0) begin
                next_state               = PAD;
